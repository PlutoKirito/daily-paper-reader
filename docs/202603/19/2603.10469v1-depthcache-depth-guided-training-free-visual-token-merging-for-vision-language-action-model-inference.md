...
result: "在LIBERO基准测试中实现高达1.28倍的推理加速，且在多种VLA模型上的成功率下降不到1%，显著优于传统剪枝和合并方法。"
conclusion: DepthCache通过深度引导的Token管理，在不修改模型的前提下有效平衡了VLA模型的推理效率与操作精度。
---
